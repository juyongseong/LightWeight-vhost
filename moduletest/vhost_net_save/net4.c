...
extern void vhost_printk_status(struct vhost_net *net, const char *str) {
	...
	printk(KERN_ALERT "tx_nvq:%p, rx_nvq:%p, tx_nvq_vq:%p rx_nvq_vq:%p\n",nvq,nvq2,vq,vq2);
}
...
static void handle_tx(struct vhost_net *net)
{
	...
	//jy
	//jy
	vhost_printk_status(net, __func__);
	//jy
	//jy
...
static int vhost_net_open(struct inode *inode, struct file *f)
{
	...
	//jy
	vhost_printk_status(n, __func__);
	//jy
